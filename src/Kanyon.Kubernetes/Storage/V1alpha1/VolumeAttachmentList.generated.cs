...
namespace Kapitan.Kubernetes.Storage.V1alpha1
{
    public partial class VolumeAttachmentList : IManifestObject
    {
        ...
        public IEnumerable<Storage.V1alpha1.VolumeAttachment> items { get; set; }
