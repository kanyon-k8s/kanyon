...
namespace Kapitan.Kubernetes.Authentication.V1beta1
{
    public partial class TokenReview : IManifestObject
    {
        ...
        public Authentication.V1beta1.TokenReviewSpec spec { get; set; }
        /** <summary>TokenReviewStatus is the result of the token authentication request.</summary> */
        public Authentication.V1beta1.TokenReviewStatus status { get; set; }
    }
}