...
namespace Kapitan.Kubernetes.Core.V1
{
    public partial class PodAntiAffinity
    {
        ...
        public IEnumerable<Core.V1.WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution { get; set; }
        ...
        public IEnumerable<Core.V1.PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution { get; set; }
    }
}