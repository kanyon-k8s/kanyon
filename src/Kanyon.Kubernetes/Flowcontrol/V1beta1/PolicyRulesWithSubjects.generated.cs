...
namespace Kanyon.Kubernetes.Flowcontrol.V1beta1
{
    public partial class PolicyRulesWithSubjects
    {
        ...
        public IEnumerable<Flowcontrol.V1beta1.NonResourcePolicyRule> nonResourceRules { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta1.ResourcePolicyRule> resourceRules { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta1.Subject> subjects { get; set; }
    }
}