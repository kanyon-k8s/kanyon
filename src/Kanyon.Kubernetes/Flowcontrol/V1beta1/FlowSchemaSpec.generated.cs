...
namespace Kanyon.Kubernetes.Flowcontrol.V1beta1
{
    public partial class FlowSchemaSpec
    {
        ...
        public Flowcontrol.V1beta1.FlowDistinguisherMethod distinguisherMethod { get; set; }
        ...
        public Flowcontrol.V1beta1.PriorityLevelConfigurationReference priorityLevelConfiguration { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta1.PolicyRulesWithSubjects> rules { get; set; }
    }
}