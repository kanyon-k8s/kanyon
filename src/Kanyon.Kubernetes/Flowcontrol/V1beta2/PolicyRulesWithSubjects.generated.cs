...
namespace Kanyon.Kubernetes.Flowcontrol.V1beta2
{
    public partial class PolicyRulesWithSubjects
    {
        ...
        public IEnumerable<Flowcontrol.V1beta2.NonResourcePolicyRule> nonResourceRules { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta2.ResourcePolicyRule> resourceRules { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta2.Subject> subjects { get; set; }
    }
}