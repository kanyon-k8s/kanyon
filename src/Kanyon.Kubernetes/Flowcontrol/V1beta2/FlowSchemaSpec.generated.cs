...
namespace Kanyon.Kubernetes.Flowcontrol.V1beta2
{
    public partial class FlowSchemaSpec
    {
        ...
        public Flowcontrol.V1beta2.FlowDistinguisherMethod distinguisherMethod { get; set; }
        ...
        public Flowcontrol.V1beta2.PriorityLevelConfigurationReference priorityLevelConfiguration { get; set; }
        ...
        public IEnumerable<Flowcontrol.V1beta2.PolicyRulesWithSubjects> rules { get; set; }
    }
}