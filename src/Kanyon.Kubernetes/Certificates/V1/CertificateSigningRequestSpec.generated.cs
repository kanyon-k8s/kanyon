...
As of v1.22, this field is beta and is controlled via the CSRDuration feature gate.</summary> */
...
Custom signerNames can also be specified. The signer defines:
 ...
 6. Whether or not requests for CA certificates are allowed.</summary> */
        public string signerName { get; set; }
        /** <summary>uid contains the uid of the user that created the CertificateSigningRequest. Populated by the API server on creation and immutable.</summary> */
