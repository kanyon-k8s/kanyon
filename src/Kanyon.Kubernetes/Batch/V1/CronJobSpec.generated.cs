...
namespace Kanyon.Kubernetes.Batch.V1
{
    public partial class CronJobSpec
    {
        ...
        /** <summary>The number of failed finished jobs to retain. Value must be non-negative integer. Defaults to 1.</summary> */
        ...
        public Batch.V1.JobTemplateSpec jobTemplate { get; set; }
        ...
        /** <summary>The number of successful finished jobs to retain. Value must be non-negative integer. Defaults to 3.</summary> */
