...
namespace Kapitan.Kubernetes.Apiextensions.V1beta1
{
    public partial class CustomResourceDefinitionSpec
    {
        ...
        public List<Apiextensions.V1beta1.CustomResourceColumnDefinition> additionalPrinterColumns { get; set; }
        ...
        public List<Apiextensions.V1beta1.CustomResourceDefinitionVersion> versions { get; set; }
    }
}