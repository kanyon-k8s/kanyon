...
namespace Kapitan.Kubernetes.Core.V1
{
    public partial class PodStatus
    {
        ...
        public List<Core.V1.PodCondition> conditions { get; set; }
        ...
        public List<Core.V1.ContainerStatus> containerStatuses { get; set; }
        ...
        public List<Core.V1.ContainerStatus> ephemeralContainerStatuses { get; set; }
        ...
        public List<Core.V1.ContainerStatus> initContainerStatuses { get; set; }
...
More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-phase</summary> */
        ...
        public List<Core.V1.PodIP> podIPs { get; set; }
