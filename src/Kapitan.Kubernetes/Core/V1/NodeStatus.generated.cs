...
namespace Kapitan.Kubernetes.Core.V1
{
    public partial class NodeStatus
    {
        ...
        public List<Core.V1.NodeAddress> addresses { get; set; }
        ...
        public List<Core.V1.NodeCondition> conditions { get; set; }
        ...
        public List<Core.V1.ContainerImage> images { get; set; }
        ...
        public List<Core.V1.AttachedVolume> volumesAttached { get; set; }
