...
namespace Kapitan.Kubernetes.Core.V1
{
    public partial class EndpointSubset
    {
        ...
        public List<Core.V1.EndpointAddress> addresses { get; set; }
        ...
        public List<Core.V1.EndpointAddress> notReadyAddresses { get; set; }
        /** <summary>Port numbers available on the related IP addresses.</summary> */
        public List<Core.V1.EndpointPort> ports { get; set; }
    }
}