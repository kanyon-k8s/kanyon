...
namespace Kapitan.Kubernetes.Core.V1
{
    public partial class PodAffinity
    {
        ...
        public List<Core.V1.WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution { get; set; }
        ...
        public List<Core.V1.PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution { get; set; }
    }
}