...
namespace Kapitan.Kubernetes.Policy.V1beta1
{
    public partial class PodSecurityPolicySpec
    {
        ...
        public List<Policy.V1beta1.AllowedCSIDriver> allowedCSIDrivers { get; set; }
        ...
        public List<Policy.V1beta1.AllowedFlexVolume> allowedFlexVolumes { get; set; }
        /** <summary>allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used.</summary> */
        public List<Policy.V1beta1.AllowedHostPath> allowedHostPaths { get; set; }
...
Examples: e.g. "foo/&#42;" forbids "foo/bar", "foo/baz", etc. e.g. "foo.&#42;" forbids "foo.bar", "foo.baz", etc.</summary> */
        ...
        public List<Policy.V1beta1.HostPortRange> hostPorts { get; set; }
