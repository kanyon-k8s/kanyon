...
namespace Kapitan.Kubernetes.Autoscaling.V2beta2
{
    public partial class HorizontalPodAutoscalerStatus
    {
        ...
        public List<Autoscaling.V2beta2.HorizontalPodAutoscalerCondition> conditions { get; set; }
        /** <summary>currentMetrics is the last read state of the metrics used by this autoscaler.</summary> */
        public List<Autoscaling.V2beta2.MetricStatus> currentMetrics { get; set; }
