...
namespace Kapitan.Kubernetes.Rbac.V1beta1
{
    public partial class RoleBindingList : IManifestObject
    {
        ...
        public IEnumerable<Rbac.V1beta1.RoleBinding> items { get; set; }
